class RequestsController < ApplicationController
	...
	def confirm
	    ...
	    notification = User.find_by(id: current_request.requester_id).notifications.build(read: false, content: User.find_by(id: current_request.requested_id).fname + " has accepted your request to read", destination: "note", group: current_request.group_id)
	    notification.save
